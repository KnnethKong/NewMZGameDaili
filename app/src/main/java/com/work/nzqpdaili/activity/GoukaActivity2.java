...
import com.work.nzqpdaili.fragment.GoukFragment2;
import com.work.nzqpdaili.fragment.ShoukaFragment2;
...
public class GoukaActivity2 extends BaseActivity implements View.OnClickListener{
    ...
    private GoukFragment2 zixunFragment1;
    private ShoukaFragment2 zixunFragment2;
    @Override
    ...
    public void initView() {
        ((TextView) findViewById(R.id.tv_title)).setText("购卡售卡");
        ...
        zixunFragment1 = new GoukFragment2();
        Bundle bundle1 = new Bundle();
        bundle1.putString("id",getIntent().getStringExtra("id"));
        zixunFragment1.setArguments(bundle1);
        fragments.add(zixunFragment1);
        zixunFragment2 = new ShoukaFragment2();
        zixunFragment2.setArguments(bundle1);
        fragments.add(zixunFragment2);
        mVp_order.setAdapter(new mFragmentAdapter(getSupportFragmentManager()));
