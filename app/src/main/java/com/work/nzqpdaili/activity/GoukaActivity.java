...
import com.work.nzqpdaili.fragment.GoukFragment;
import com.work.nzqpdaili.fragment.ShoukaFragment;
...
public class GoukaActivity extends BaseActivity implements View.OnClickListener{
    ...
    private GoukFragment zixunFragment1;
    private ShoukaFragment zixunFragment2;
    @Override
    ...
    public void initView() {
        ...
        zixunFragment1 = new GoukFragment();
        Bundle bundle1 = new Bundle();
        bundle1.putString("id",getIntent().getStringExtra("id"));
        zixunFragment1.setArguments(bundle1);
        fragments.add(zixunFragment1);
        zixunFragment2 = new ShoukaFragment();
        fragments.add(zixunFragment2);
        mVp_order.setAdapter(new GoukaActivity.mFragmentAdapter(getSupportFragmentManager()));
