...
import com.work.nzqpdaili.Bean.GoulamyBean;
...
public class GoukFragment extends BaseFragment{
    private XListView mList;
    private QuickAdapter<GoulamyBean> adapter;
    private List<GoulamyBean> array;
    private List<GoulamyBean> listall = new ArrayList<GoulamyBean>();
    private int page = 1;
    ...
    public void initData() {
        ...
        httplist();
        adapter = new QuickAdapter<GoulamyBean>(getActivity(),R.layout.itrm_gouka,listall){

            @Override
            protected void convert(BaseAdapterHelper helper, GoulamyBean item) {
                ...
                helper.setText(R.id.content,item.getPackdesc());
    ...
    private void httplist() {
        ...
        list.add(new Parameter("a", "mode_sale"));
            ...
            public void onHttpRequestSuccess(int requestCode, int resultCode, String resultData, String resultJson) {
                ...
                try {
                    ...
                    if (jsonObject.getString("status").equals("10001")) {
                        ...
                        array = JSON.parseArray(agent.toString(), GoulamyBean.class);
                        JSONObject zong = data.getJSONObject("sal");
     ...
     * 读取的网络数据添加
     */
    private void dataListToArrayList(List<GoulamyBean> dataList) {
