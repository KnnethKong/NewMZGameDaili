 ...
 */
package com.work.nzqpdaili.adapter.baseadapter;
...
public class BaseAdapterHelper {
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setText(int viewId, String value, int color) {
        TextView view = retrieveView(viewId);
        view.setText(value);
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setTextByEmpty(int viewId, String value) {
        TextView view = retrieveView(viewId);
