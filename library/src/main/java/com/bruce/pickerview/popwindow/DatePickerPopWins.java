 ...
 */
public class DatePickerPopWins extends PopupWindow implements OnClickListener {
    ...
    public static class Builder{
        ...
        public Builder(Context context,int year,int month,int day,OnDatePickedListener listener){
        ...
        public DatePickerPopWins build(){
            if(minYear > maxYear){
                throw new IllegalArgumentException();
            }
            return new DatePickerPopWins(this);
        }
    ...
    public DatePickerPopWins(Builder builder){
...
//        Toast.makeText(mContext,hour+"",Toast.LENGTH_SHORT).show();
        int years = c.get(Calendar.YEAR);//获取年份
        final int months = c.get(Calendar.MONTH);//获取月份
        for (int i = 0; i < 12; i++) {
            if (years==year&&months+1==month&&days == day) {
                if (hour == 1) {
                    if (i > 0) dayList.add(i * 2 + ":00 - " + (i * 2 + 2) + ":00");
                } else if (hour == 3||hour == 2) {
                    if (i > 1) dayList.add(i * 2 + ":00 - " + (i * 2 + 2) + ":00");
                } else if (hour == 5||hour == 4) {
                    if (i > 2) dayList.add(i * 2 + ":00 - " + (i * 2 + 2) + ":00");
                } else if (hour == 7||hour == 6) {
                    if (i > 3) dayList.add(i * 2 + ":00 - " + (i * 2 + 2) + ":00");
                } else if (hour == 9||hour == 8) {
                    if (i > 4) dayList.add(i * 2 + ":00 - " + (i * 2 + 2) + ":00");
                } else if (hour == 11||hour == 10) {
                    if (i > 5) dayList.add(i * 2 + ":00 - " + (i * 2 + 2) + ":00");
                }else if (hour == 13||hour == 12) {
                    if (i > 6) dayList.add(i * 2 + ":00 - " + (i * 2 + 2) + ":00");
                }else if (hour == 15||hour == 14) {
                    if (i > 7) dayList.add(i * 2 + ":00 - " + (i * 2 + 2) + ":00");
                }else if (hour == 17||hour == 16) {
                    if (i > 8) dayList.add(i * 2 + ":00 - " + (i * 2 + 2) + ":00");
                }else if (hour == 19||hour == 18) {
                    if (i > 9) dayList.add(i * 2 + ":00 - " + (i * 2 + 2) + ":00");
                }else if (hour == 21||hour == 20) {
                    if (i > 10) dayList.add(i * 2 + ":00 - " + (i * 2 + 2) + ":00");
                }
            }else {
                dayList.add(i * 2 + ":00 - " + (i * 2 + 2) + ":00");
            }
    ...
    public void onClick(View v) {
        ...
        if (v == contentView || v == cancelBtn) {
            ...
            if (null != mListener) {
                ...
                String day = dayList.get(dayLoopView.getSelectedItem());
...
//                sb.append(format2LenStr(day));
    ...
    public interface OnDatePickedListener {
         ...
         */
        void onDatePickCompleted(int year, int month, String day,
                                 String dateDesc);
    }
}
