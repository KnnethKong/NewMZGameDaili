 ...
 */
public class DatePickerPopWint extends PopupWindow implements OnClickListener {
    ...
    public static class Builder{
        ...
        public DatePickerPopWint build(){
            if(minYear > maxYear){
                throw new IllegalArgumentException();
            }
            return new DatePickerPopWint(this);
        }
    ...
    public DatePickerPopWint(Builder builder){
    ...
    private void initView() {
        ...
        contentView = LayoutInflater.from(mContext).inflate( R.layout.layout_date_pickert, null);
...
//        dayLoopView.setTextSize(25);
    ...
    private void initPickerViews() {
        ...
        for (int j = 0; j < 24; j++) {
            monthList.add(format2LenStr(j + 1)+"时");
        }
    ...
    private void initDayPickerView() {
        ...
        for (int i = 0; i < 60; i++) {
            dayList.add(format2LenStr(i + 1)+"分");
        }
    ...
    public void setSelectedDate(String dateStr) {
        ...
        if (!TextUtils.isEmpty(dateStr)) {
            ...
            if (milliseconds != -1) {
                ...
                monthPos = calendar.get(Calendar.HOUR_OF_DAY)-1;
                dayPos = calendar.get(Calendar.MINUTE) - 1;
            }
        }
    }
