 ...
 */
public abstract class BaseNoStatusBarActivity extends FragmentActivity implements ActivityPresenter, OnGestureListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		context = (BaseNoStatusBarActivity) getActivity();
		isAlive = true;
...
if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
		...
		tintManager.setStatusBarTintResource(R.color.transparent);//状态背景色，可传drawable资源
