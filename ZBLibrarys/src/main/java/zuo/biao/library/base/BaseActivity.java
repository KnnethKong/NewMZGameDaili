...
import zuo.biao.library.util.OsUtil;
...
//            getWindow().addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_NAVIGATION);
	 ...
	 */
	protected void setImmersiveStatusBar(boolean fontIconDark, int statusBarColor, LinearLayout linearLayout) {
		...
		if (fontIconDark) {
			if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M
				...
				if (statusBarColor == Color.WHITE) {
					...
					linearLayout.setBackgroundColor(statusBarColor);
				}
			}
		}
