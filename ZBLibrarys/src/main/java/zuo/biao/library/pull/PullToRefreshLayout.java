...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    public static final int OVRE = 2;
    ...
    public void refreshFinish(int refreshResult) {
        ...
        last_refresh_time.setVisibility(View.GONE);
...
//			loadStateTextView.setText(R.string.xlistview_footer_hint_over);
//			loadingView.setVisibility(View.GONE);
...
//			loadStateImageView.setBackgroundResource(R.drawable.load_succeed);
    ...
    private void changeState(int to) {
        last_refresh_time.setVisibility(View.VISIBLE);
//		loadmoreView.setVisibility(VISIBLE);
        state = to;
        switch (state) {
            case INIT:
            ...
            case DONE:
//			loadmoreView.setVisibility(GONE);
                refreshStateImageView.setVisibility(GONE);
                loadingView.setVisibility(GONE);
                pullUpView.setVisibility(GONE);
//			loadStateTextView.setText(R.string.xlistview_footer_hint_over);
...
//			pullUpView.setVisibility(View.INVISIBLE);
    ...
    public void setRefreshTime(String time) {
        if (last_refresh_time != null) {
            last_refresh_time.setVisibility(View.VISIBLE);
            last_refresh_time.setText(time);
        } else {
    ...
    private void initView() {
        ...
        last_refresh_time = (TextView) refreshView.findViewById(R.id.last_refresh_time);
        refreshingView = refreshView.findViewById(R.id.refreshing_icon);
        refreshStateImageView = refreshView.findViewById(R.id.state_iv);

        SharedPreferences sp = mContext.getSharedPreferences("lastRefreshTime", Context.MODE_PRIVATE);
        String time_content = getResources().getString(R.string.xlistview_header_last_refresh_time) + sp.getString("lastTime", "");
        setRefreshTime(time_content);
